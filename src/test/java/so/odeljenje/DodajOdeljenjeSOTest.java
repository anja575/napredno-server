...
class DodajOdeljenjeSOTest {
	
	DodajOdeljenjeSO so;

	@BeforeEach
	void setUp() throws Exception {
		so = new DodajOdeljenjeSO();
	}
	...
	@Test
	public void testUspesnoDodatoOdeljenje() {
		...
		int brojOdeljenjaPreDodavanja = odeljenja.size();
		...
		assertEquals(brojOdeljenjaPreDodavanja + 1, odeljenja.size());
	...
	@Test
	public void testVanOpsegaBrojaUcenika() {
        Odeljenje odeljenje = new Odeljenje();
		...
		assertThrows(Exception.class, () -> so.izvrsavanje(odeljenje));
